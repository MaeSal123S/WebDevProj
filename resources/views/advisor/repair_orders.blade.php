...
<div class="panel">
    <div class="panel-header">
        <div class="panel-title">My repair order list</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form method="POST"
                        action="{{ route('advisor.repair_orders.destroy', $row->order_no) }}"
            ...
            @empty
            <tr>
                <td colspan="6" class="empty-row">No repair orders found</td>
            </tr>
            @endforelse
        </tbody>
    </table>
...
<div class="modal-overlay" id="addModal">
    <div class="modal-box" style="width:500px">
        ...
        <form method="POST" action="{{ route('advisor.repair_orders.store') }}">
            @csrf
...
<script>
    ...
    function openEditModal(id, date, customerId, vehicleId, serviceTypeIds) {
